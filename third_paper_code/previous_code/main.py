...
def update_schedule(schedule):
    while True:
        start_times_body, completion_times_body, start_times_cabinet, completion_times_cabinet, start_times_pipeline, completion_times_pipeline, total_processing_time_all, order_percentages, remember = fitness_function(schedule)
...
for i in range(len(schedule)):
    order = schedule[i]
    print(f"order {order}, release_time: {release_times_special[order]}, end time: {completion_times_pipeline[order]}, profit: {single_profits[i]}")
